...
from app.main import Dwarf
from app.main import DwarfBlacksmith
from app.main import DwarfWarrior
from app.main import Druid
from app.main import Elf
from app.main import ElfRanger
